...
#      ================== <custom_data>, if present ==================
        ...
        name_btn.style.button_color = 'lightgreen'
        self.float54 = FloatText(value='250', step='10', style=style, layout=widget_layout)
...
#      ================== <custom_data>, if present ==================
        ...
        self.cell_def_vbox1 = VBox([
          div_row9, death_model1,box63, div_row10, self.bool5,div_row11,         ])
        # ------------------------------------------
...
self.cell_def_vbox0, self.cell_def_vbox1,         ])
    ...
    def fill_gui(self, xml_root):
        ...
        # ------------------ cell_definition: lung epithelium
        # ---------  death 
        self.float61.value = float(uep.find('.//cell_definition[2]//phenotype//death//model[1]//death_rate').text)
        # ---------  motility 
    ...
    def fill_xml(self, xml_root):
        ...
        # ------------------ cell_definition: lung epithelium
        # ---------  death 
        uep.find('.//cell_definition[2]//phenotype//death//model[1]//death_rate').text = str(self.float61.value)
        # ---------  motility 
