...
class UserTab(object):
    ...
    def __init__(self):
        ...
        param_name5 = Button(description='drug_virion_uncoated', disabled=True, layout=name_button_layout)
        ...
        param_name6 = Button(description='drug_virion_export', disabled=True, layout=name_button_layout)
        ...
        param_name7 = Button(description='drug_ACE2_binding_rate', disabled=True, layout=name_button_layout)
        ...
        desc_button11 = Button(description='ACE2 receptor-virus endocytosis rate with drug' , tooltip='ACE2 receptor-virus endocytosis rate with drug', disabled=True, layout=desc_button_layout) 
        desc_button11.style.button_color = 'lightgreen'
        desc_button12 = Button(description='rate at which uncoated virion makes its mRNA available with drug' , tooltip='rate at which uncoated virion makes its mRNA available with drug', disabled=True, layout=desc_button_layout) 
        desc_button12.style.button_color = 'tan'
        desc_button13 = Button(description='rate at which a virion is exported from a live cell with drug' , tooltip='rate at which a virion is exported from a live cell with drug', disabled=True, layout=desc_button_layout) 
        desc_button13.style.button_color = 'lightgreen'
        desc_button14 = Button(description='ACE2 receptor-virus binding rate with drug' , tooltip='ACE2 receptor-virus binding rate with drug', disabled=True, layout=desc_button_layout) 
        desc_button14.style.button_color = 'tan'
        desc_button15 = Button(description='rate at which uncoated virion makes its mRNA available with drug' , tooltip='rate at which uncoated virion makes its mRNA available with drug', disabled=True, layout=desc_button_layout) 
        desc_button15.style.button_color = 'lightgreen'
        desc_button16 = Button(description='rate at mRNA creates complete set of proteins with drug' , tooltip='rate at mRNA creates complete set of proteins with drug', disabled=True, layout=desc_button_layout) 
        desc_button16.style.button_color = 'tan'
        desc_button17 = Button(description='rate at which viral proteins are assembled into complete virion with drug' , tooltip='rate at which viral proteins are assembled into complete virion with drug', disabled=True, layout=desc_button_layout) 
        desc_button17.style.button_color = 'lightgreen'
        desc_button18 = Button(description='The injected drug concentration' , tooltip='The injected drug concentration', disabled=True, layout=desc_button_layout) 
        desc_button18.style.button_color = 'tan'
        desc_button19 = Button(description='Drug concentration value that gives 50% max effect' , tooltip='Drug concentration value that gives 50% max effect', disabled=True, layout=desc_button_layout) 
        desc_button19.style.button_color = 'lightgreen'
        desc_button20 = Button(description='Power that used in Hill Function for calculating drug effect' , tooltip='Power that used in Hill Function for calculating drug effect', disabled=True, layout=desc_button_layout) 
        desc_button20.style.button_color = 'tan'
        desc_button21 = Button(description='Drug efficiency on inhibition of virion multiplication ([0, 1])' , tooltip='Drug efficiency on inhibition of virion multiplication ([0, 1])', disabled=True, layout=desc_button_layout) 
        desc_button21.style.button_color = 'lightgreen'
        desc_button22 = Button(description='The time duration between two dose injection' , tooltip='The time duration between two dose injection', disabled=True, layout=desc_button_layout) 
        desc_button22.style.button_color = 'tan'
        desc_button23 = Button(description='Time that first dose injection' , tooltip='Time that first dose injection', disabled=True, layout=desc_button_layout) 
        desc_button23.style.button_color = 'lightgreen'
        desc_button24 = Button(description='Rate at which lung epithelium uptakes drug' , tooltip='Rate at which lung epithelium uptakes drug', disabled=True, layout=desc_button_layout) 
        desc_button24.style.button_color = 'tan'
        desc_button25 = Button(description='Turn on the drug effect on virial endocytosis and export or not' , tooltip='Turn on the drug effect on virial endocytosis and export or not', disabled=True, layout=desc_button_layout) 
        desc_button25.style.button_color = 'lightgreen'
        desc_button26 = Button(description='Turn on the drug effect on virial binding and replication or not' , tooltip='Turn on the drug effect on virial binding and replication or not', disabled=True, layout=desc_button_layout) 
        desc_button26.style.button_color = 'tan'
        desc_button27 = Button(description='color cells based on this variable' , tooltip='color cells based on this variable', disabled=True, layout=desc_button_layout) 
        desc_button27.style.button_color = 'lightgreen'
        desc_button28 = Button(description='apoptotic epithelial cell color' , tooltip='apoptotic epithelial cell color', disabled=True, layout=desc_button_layout) 
        ...
        row11 = [param_name4, self.drug_ACE2_endocytosis_rate, units_button6, desc_button11] 
        row12 = [param_name5, self.drug_virion_uncoated, units_button7, desc_button12] 
        row13 = [param_name6, self.drug_virion_export, units_button8, desc_button13] 
        row14 = [param_name7, self.drug_ACE2_binding_rate, units_button9, desc_button14] 
        row15 = [param_name8, self.drug_uncoated_to_RNA_rate, units_button10, desc_button15] 
        row16 = [param_name9, self.drug_protein_synthesis_rate, units_button11, desc_button16] 
        row17 = [param_name10, self.drug_virion_assembly_rate, units_button12, desc_button17] 
        row18 = [param_name11, self.drug_doses, units_button14, desc_button18] 
        row19 = [param_name12, self.EC_50, units_button15, desc_button19] 
        row20 = [param_name13, self.Hill_power, units_button16, desc_button20] 
        row21 = [param_name14, self.drug_efficiency, units_button17, desc_button21] 
        row22 = [param_name15, self.dose_duration, units_button18, desc_button22] 
        row23 = [param_name16, self.start_inject, units_button19, desc_button23] 
        row24 = [param_name17, self.internalization_rate, units_button20, desc_button24] 
        row25 = [param_name18, self.drug_endo_export, units_button21, desc_button25] 
        row26 = [param_name19, self.drug_binding_replication, units_button22, desc_button26] 
        row27 = [param_name20, self.color_variable, units_button24, desc_button27] 
        row28 = [param_name21, self.apoptotic_epithelium_color, units_button25, desc_button28] 
